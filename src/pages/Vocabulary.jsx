...
function Vocabulary() {
  ...
  return (
    <div className="max-w-2xl">
      ...
      <form onSubmit={handleSubmit} className="bg-white/80 backdrop-blur-sm border border-rose-100 rounded-2xl p-5 mb-6 flex flex-col gap-3 shadow-sm">
      ...
      {data.vocab.length === 0 ? (
        ...
        <div className="grid sm:grid-cols-2 gap-3">
          {[...data.vocab].reverse().map((w) => (
            <div key={w.id} className="bg-white/80 backdrop-blur-sm border border-rose-100 rounded-xl p-4 relative shadow-sm">
              <button
              ...
              <p className="text-sm text-rose-600 mb-1">{w.translation}</p>
